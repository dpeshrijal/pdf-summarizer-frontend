      ...
      <main className="container mx-auto px-4 md:px-6 py-12 max-w-4xl">
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>
              Welcome to Resumi. We respect your privacy and are committed to
              protecting your personal data. This Privacy Policy explains how we
              collect, use, disclose, and safeguard your information when you
              use our Service.
            </p>
            <p className="mt-3">
              By using Resumi, you agree to the collection and use of
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Profile Information:</strong> Professional links
                (LinkedIn, GitHub, portfolio)
              </li>
              <li>
                <strong>Resume Content:</strong> Your uploaded resume in PDF
                format
              </li>
              <li>
                <strong>Job Descriptions:</strong> Job postings you paste for
                tailoring
              </li>
              <li>
                <strong>Payment Information:</strong> Processed securely by
                Paddle (we don't store card details)
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Usage Data:</strong> Features used, generation history,
                time spent
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Provide the Service:</strong> Generate tailored resumes
                and cover letters using AI
              </li>
              <li>
                <strong>Account Management:</strong> Create and manage your
                account, process payments
              </li>
              <li>
              ...
              <li>
                <strong>Communication:</strong> Send updates, security alerts,
          ...
          <section className="mb-8">
            ...
            <p>
              We use artificial intelligence services (including OpenAI's GPT
              models) to generate tailored resumes and cover letters. When you
              use our Service:
            </p>
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li>
                Your resume content and job descriptions are sent to AI
                providers for processing
              </li>
              <li>
                AI providers may use this data to improve their models (per
                their policies)
              </li>
              <li>
                We implement safeguards to minimize personal information sent to
                AI services
              </li>
              <li>
                Generated content is stored in our secure database for your
                access
              </li>
            </ul>
            <p className="mt-3">
              We recommend not including highly sensitive information (SSN,
              passport numbers, etc.) in your resumes.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>OpenAI:</strong> AI-powered resume generation
              </li>
              <li>
                <strong>Paddle:</strong> Payment processing
              </li>
              <li>
                <strong>AWS:</strong> Hosting and storage infrastructure
              </li>
            </ul>
            ...
            <p>
              If Resumi is involved in a merger, acquisition, or asset sale,
              your data may be transferred. We will notify you before your data
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Access Controls:</strong> Strict access limitations to
                your personal data
              </li>
              <li>
                <strong>Secure Storage:</strong> Data stored on AWS with
                enterprise-grade security
              </li>
              <li>
                <strong>Regular Audits:</strong> Security practices reviewed and
                updated regularly
              </li>
            </ul>
            <p className="mt-3">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li>
                <strong>Resume Content:</strong> Stored until you delete it or
                close your account
              </li>
              <li>
                <strong>Generation History:</strong> Retained for 12 months or
          ...
          <section className="mb-8">
            ...
            <p>
              You can access and download your data through your account
              settings.
            </p>

            <h3 className="text-xl font-semibold mb-2 mt-4">8.2 Correction</h3>
            <p>
              You can update your profile and resume information at any time.
            </p>

            <h3 className="text-xl font-semibold mb-2 mt-4">8.3 Deletion</h3>
            <p>
              You can delete your uploaded resumes, generation history, or
              entire account. Contact us at support@resumi.com for assistance.
            </p>
            ...
            <p>
              ...
              any email. You cannot opt out of service-related emails (billing,
              security alerts).
            </p>
            ...
            <p>
              If you're in the EU, you have additional rights including data
              portability, restriction of processing, and the right to lodge a
